...
import com.example.praktikum8.ui.home.screen.DestinasiDetail.NIM
...
import com.example.praktikum8.ui.home.screen.DetailMhsView
    ...
    NavHost(
        ...
        composable(DestinasiHome.route){
            HomeScreen(
                ...
                onDetailClick = {  navController.navigate("${DestinasiDetail.route}/$NIM")
                    println(
                        "PengelolaHalaman: kode = $NIM"
                    )
